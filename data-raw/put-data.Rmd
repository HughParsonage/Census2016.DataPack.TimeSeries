...
Mop <- function(DT, value.name = "persons", suborder = NULL) {
  ...
  switch(
    ...
    "occupied_private_dwellings" = {
      ...
      if (abs(tot_dwellings - exp_tot_dwellings) / exp_tot_dwellings > 0.0004 * nrow(out)) {
